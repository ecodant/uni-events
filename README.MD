...
Based on your Operating System you must to add the JavaFX SDK folder for your system under the name "javafx-sdk",you can download the version that you need [here](https://gluonhq.com/products/javafx/)
